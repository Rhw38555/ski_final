...
<body>
	<h2> 콘도 미리보기 </h2>
	<input type="button" value="2인실" onclick="location='introCondoView2.do'">
	<input type="button" value="4인실" onclick="location='introCondoView4.do'">
	<input type="button" value="8인실" onclick="location='introCondoView8.do'">
	<br><br>
	<div class="demo">
        <div class="item">            
