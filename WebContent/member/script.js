   ...
   if(numcheck == 1){      //같은 테이블 내용 붙이기
      ...
      if(roomlength-1 == i){
         roommsg += "<tr>"
            ...
            +  "<tr>"
            +  "   <td colspan='4'>"
            +  "      <a href='reverseChangeRoomForm.do?num="+memberdata.member[roomicheck].num+"' target='_blank'>예약변경"
   ...
   if(numcheck == 1){      //같은 테이블 내용 붙이기
      ...
      if(skilength-1 == i){
         skimsg += "<tr>"
            ...
            +  "<tr>"
            +  "   <td colspan='4'>"
            +  "      <a href='reverseChangeSkiForm.do?num="+memberdata.member2[skiicheck].num+"' target='_blank'>예약변경"
