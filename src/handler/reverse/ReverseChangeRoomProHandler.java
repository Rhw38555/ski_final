...
@Controller
public class ReverseChangeRoomProHandler implements CommandHandler{

	@Resource
	private ReverseDao reserveDao;
	
	@RequestMapping( "/reverseChangeRoomPro" )
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		int result = 0;
		int finalcnt = Integer.parseInt(request.getParameter("finalcnt"));
		
		int re = reserveDao.room_delete(num);
		...
		return new ModelAndView( "reverse/reverseChangeRoomPro" );
	}
