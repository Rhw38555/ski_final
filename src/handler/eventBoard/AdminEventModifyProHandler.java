...
public class AdminEventModifyProHandler implements CommandHandler{
	...
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		...
		EventBoardDataBean peventDto = new EventBoardDataBean();
        ...
        if( eventDto.getImage() == null ) {
        	eventDto.setImage( peventDto.getImage() );
        }
        System.out.println( "image:"+eventDto.getImage() );
		// thumbnail set
        String timage = "";
        String oimage = "";
        if( eventDto.getImage() != peventDto.getImage() ) {
	        if(eventDto.getImage() != null) {
    		...
    		eventDto.setThumbnail( peventDto.getThumbnail() );
    	}
