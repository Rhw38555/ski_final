...
public class EmailConfirm {
   ...
   public String loginconnectEmail(String email){
   ...
   public String connectEmail(String email){
      ...
      String fromName="관리자"; // 보내는 이름 설정
      String from="nhwoo38555@gamil.com"; // 보내는 사람(구글계정)
      String id= memberDao.findId(email);// 아이디 보내주기
   ...
   public String connectEmailPasswd(String id, String email){
      LogonDBBean memberDao = LogonDBBean.getInstance();
      String to1=email; // 인증위해 사용자가 입력한 이메일주소
      String host="smtp.gmail.com"; // smtp 서버
      ...
      String fromName="관리자"; // 보내는 이름 설정
      String from="nhwoo38555@gamil.com"; // 보내는 사람(구글계정)
      String passwd= memberDao.findPasswd(id,email);// 아이디 보내주기
      ...
      Session mailSession 
           = Session.getInstance(props,new javax.mail.Authenticator(){
             protected PasswordAuthentication getPasswordAuthentication(){
                return new PasswordAuthentication
                                        ("nhwoo38555@gmail.com","we34r2930@"); // 
         }
      });
